...
import { Bell, Moon, Sun, AlertTriangle, Info, Clock, Menu, Settings2 } from 'lucide-react';
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {hasPermission('canManageNotifications') && (
                      <Link 
                        ...
                        className="p-1.5 rounded-lg hover:bg-hover-bg text-text-secondary hover:text-primary-400 transition-colors"
